package pl.servicealerts.scheduler;
...
@Slf4j
@Component
public class BackUpToFileScheduler {
    ...
    public void saveAllAlertsToFile() {
        ...
        try {
            ...
            log.info("Successfully safe {} alerts to cache list file : {}", serviceAlertList.size(), outputPath);
